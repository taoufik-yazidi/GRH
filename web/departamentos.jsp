...
<html>
    ...
    <body>
        ...
        <section>
            <div class="row">
                <form id="frmFormulario" class="form-horizontal" role="form" action="SDepartamentos" method="post">
                    <fieldset class="col-sm-3 col-sm-offset-1 col-lg-3 col-lg-offset-2">
                        <legend>Departamentos</legend>
                        <div class="input-group">
                            <span class="input-group-addon">iddepartamento</span>
                            <input type="number" class="form-control" id="iddepartamento" name="iddepartamento" placeholder="iddepartamento" readonly>
                        </div>
                        <div class="input-group">
        ...
        <section>
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <form id="frmLista" class="form-horizontal" role="form" action="SDepartamentos" method="post">					<div class="input-group">
                            ...
                            <select class="form-control" id="cor" name="cor">
                                <option value="1"">iddepartamento</option>
        ...
        <section>
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-condensed">
                    ...
                    <thead>
                        <tr><th>iddepartamento</th><th>codigo</th><th>nombre</th><th colspan="2">Acciones</th></tr>
                    </thead>
